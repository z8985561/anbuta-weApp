...
Page({
  ...
  onLoad: function (t) {
    ...
    if (t.option){
      var _option = JSON.parse(t.option);
      t.option = _option;
    }
    i.setData({
      options: t
  ...
  inputNumber(t){
    var e = this, s = a.pdata(t), d = t.detail.value, o = s.id, c = e.data.list, n = 0, l = 0, goodslist = {};
    e.setData({
      coupon: '',
      "data.couponname": null,
    })
    ...
    if (0 == this.data.goods.giftid && 1 == this.data.goods.gifts.length && (d = this.data.goods.gifts[0].id),
      ...
      e.setData({
        ...
        e.setData({
          ...
          url: "/pages/order/success/index?id=" + t.orderid
        }) : a.alert(t.message);
      }, !0);
    }
  },
